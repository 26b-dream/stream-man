...
def media_index(request: HttpRequest):
    """Index page for all of the media."""
    context = {}
    return render(request, "media/index.html", context)


def show_index(request: HttpRequest, show_id: int):
...
def season_index(request: HttpRequest, season_id: int):
...
def episode_index(request: HttpRequest, episode_id: int):
